...
for video_extension in video_extensions:
	...
	# videos are 30fps, grayscale, forced to 1920x1080p, and frame seekable. 
        cmd = f'ffmpeg -i "{video_file}" -vcodec libx265 -preset ultrafast -crf 15 -pix_fmt yuv420p -vf "scale=1920:1080:force_original_aspect_ratio=decrease:eval=frame,pad=1920:1080:-1:-1:color=black" -an -r 30 -max_muxing_queue_size 10000000 "{output_file}"'
